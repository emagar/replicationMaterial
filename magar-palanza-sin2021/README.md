Replication code and data for this analysis is located within the following repository [https://github.com/emagar/chileLeg](https://github.com/emagar/chileLeg/tree/master/replication).
=======
